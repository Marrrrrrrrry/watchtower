...
func NewRootCommand() *cobra.Command {
	...
	More information available at https://github.com/Marrrrrrrrry/watchtower/.
	`,
		Run:    Run,
		PreRun: PreRun,
